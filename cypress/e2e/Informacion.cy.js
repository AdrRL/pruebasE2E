describe('Información', () => {
    ...
    it('Imágenes', () => {
        ...
        cy.get(':nth-child(1) > .button-icon').should('be.visible').and('have.attr', 'src').should('include', 'assets/Sobre.png');
        cy.get(':nth-child(2) > .button-icon').should('be.visible').and('have.attr', 'src').should('include', 'assets/Linkedin.png');
    });
